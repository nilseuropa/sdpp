...
/  Modified in 2024 by nilseuropa.
/
...
/-------------------------------------------------------------------------/
  ...
  * Outport D3-D7 powers the SD card
...
/* Potential power outputs are the control DIOs, those are inverted lines */
#define VAR_INIT() {STATUSPORT=OUTPORT+1; CONTROLPORT=OUTPORT+2; outportbyte(CONTROLPORT,0x00); }
...
/* Chip Select (SD card CAT3/CS pin 1) is PPORT D2 (DB-25 pin 4) */
#define CSPIN       (0x01 << 2)
/* Connect ground to one of PPORT pins 18-25 */

/* Data channels as Power outputs */

/* PWRPINs are PPORT D3-D7 (DB-25 pin 5-9) */
#define PWRPIN1     (0x01 << 3)
#define PWRPIN2     (0x01 << 4)
#define PWRPIN3     (0x01 << 5)
#define PWRPIN4     (0x01 << 6)
#define PWRPIN5     (0x01 << 7)

#define POWER	      0XF8 // Data Power Pins mask
...
#define CLOCKBITHIGHMOSIHIGH() outportbyte(OUTPORT,POWER|MOSIPIN|CLOCKPIN)
#define CLOCKBITHIGHMOSILOW() outportbyte(OUTPORT,POWER|CLOCKPIN)
#define CLOCKBITLOWMOSIHIGH() outportbyte(OUTPORT,POWER|MOSIPIN)
#define CLOCKBITLOWMOSILOW() outportbyte(OUTPORT,POWER)
#define CLOCKBITHIGHMOSIHIGHNOCS() outportbyte(OUTPORT,POWER|MOSIPIN|CLOCKPIN|CSPIN)
#define CLOCKBITLOWMOSIHIGHNOCS() outportbyte(OUTPORT,POWER|MOSIPIN|CSPIN)
#define CS_L() outportbyte(OUTPORT,POWER|MOSIPIN)
#define CS_H() outportbyte(OUTPORT,POWER|MOSIPIN|CSPIN)
#define CK_L()
#define CONTROL_POWER_ON() outportbyte(CONTROLPORT,0x00) // unused
...
)
{
   ...
   /* MEMO: nn_INIT is defined as an empty function */
   ...
   CLOCKBITLOWMOSILOW(); /* Turn power on */
